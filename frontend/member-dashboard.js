...
// ================= STATE =================
let currentTaskId = null; // 🔥 REQUIRED FOR UPLOAD
...
// 🔥 SET DEFAULT TASK FOR UPLOAD
if (cleanSections.length && !currentTaskId) {
  currentTaskId = cleanSections[0]._id;
}
...
async function handleUpload(e) {
  e.preventDefault();
  if (!currentTaskId) {
  showUploadAlert("No task assigned yet", "error");
  return;
}
...
formData.append("taskId", currentTaskId); // 🔥 REQUIRED
